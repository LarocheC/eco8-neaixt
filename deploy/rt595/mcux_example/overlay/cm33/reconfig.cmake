mcux_add_include(
  ...
  INCLUDES  ${board_root}/${board}/eiq_examples/lisennet_se/cpu
  )
mcux_add_source(
  BASE_PATH ${SdkRootDirPath}
  SOURCES ${board_root}/${board}/eiq_examples/lisennet_se/cpu/model_ops_micro.cpp
  ${board_root}/${board}/eiq_examples/lisennet_se/cpu/model_data.h
  )
