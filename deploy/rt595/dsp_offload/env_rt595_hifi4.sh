...
#
# Adapted from the Airoha NNE overlay's build/env.sh
#   (nne_sdk_airoha @ clement/nne_overlay, gnaudio/ESW on Azure DevOps),
# which is the working Cadence setup for the GN/Airoha HiFi5 work. The ONLY substantive
# change for RT595 is the core: AIR_PREMIUM_G5_HIFI5_DSP0 (Airoha HiFi5) -> the NXP RT500
...
export XTENSA_LICENSE_FILE="2700@dkcphlic51.corp.intra-gnn.com"   # dkcphlic51 -> 100.64.1.18
...
# --- Core: the ONE real change vs the Airoha env ----------------------------------------
...
#      the license ENTITLED to it. The Airoha box has AIR_..._HIFI5, not this core —
