...
#   RUNS="$BLOCKDIAG_NBLOCK_RUNS"   ./run_sweep.sh   # blockdiag nblocks 5/10/20
#
...
# The block-diagonal control for the same block-count axis, at the blockdiag_8
# shape: 0.563M (5) / 0.355M (8, existing) / 0.285M (10) / 0.146M (20). Note
